...
_OUTPUT_PATH = Path("/home/helle246/data/isic_models/inceptionresnet")
...
if __name__ == '__main__':
    ...
    # Make data pipeline
    trds = isic_data.get_iterator("trn", BATCH_SIZE, 299, preprocess_input)
    vads = isic_data.get_iterator("val", BATCH_SIZE, 299, preprocess_input)
