...
_OUTPUT_PATH = Path("/home/helle246/data/isic_models/xception")
...
if __name__ == '__main__':
    ...
    # Make data pipeline
    trds = isic_data.get_iterator("trn", 20, 299, preprocess_input)
    vads = isic_data.get_iterator("val", 20, 299, preprocess_input)
